...
CREATE TABLE AUDIT_TP_FLYER(
   CO_AUDIT  INTEGER GENERATED ALWAYS AS IDENTITY  PRIMARY KEY,
   TI_OPER CHAR(5) NOT NULL,
   ID_FLYER CHAR(5),
   NO_FLYER VARCHAR2(50),
   IG_FLYER BFILE,
   DA_CO_USER_AUTH_APP_CREA INTEGER,
   DA_IP_USER_CREA CHAR(15),
   DA_DESKTOP_USER_CREA VARCHAR2(50),
   FE_CREA_FLYER TIMESTAMP,
   DA_CO_USER_AUTH_APP_MODI INTEGER,
   DA_IP_USER_MODI CHAR(15),
   DA_DESKTOP_USER_MODI VARCHAR2(50),
   FE_MODI_FLYER TIMESTAMP 
);
-- TABLAS SECUNDARIAS
